...
const navPacket = [{navName:'All Foods',navLink:"#"}, {navName:'Pizza',navLink:"/pizza"}, {navName:'Burgers',navLink:"/burgers"},{navName:'Icecream',navLink:"/icecream"}];
        ...
        <Toolbar disableGutters>
            ...
            >
              {navPacket.map((packet:any,i:number) => (
                <MenuItem key={packet.navName} onClick={handleCloseNavMenu}>
                  <Link to={packet.navLink}><Typography textAlign="center">{packet.navName}</Typography></Link>
                </MenuItem>
              ))}
            </Menu>
          </Box>
          ...
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Cart Page">
              ...
              <Link to={'/add-to-cart'} style={{textDecoration:"none",color:"white"}}>{storeState.cartCount}<ShoppingCartIcon/></Link>
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: '45px' }}
